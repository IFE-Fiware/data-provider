...
| `4.0.3` (your chart version) | `spec.source.targetRevision` | Target revision |
...
spec:
  ...
  source:
    ...
    helm:
      values: |
        values:
          branch: v4.0.3                               # branch of repo with values - for released version it should be the release branch
