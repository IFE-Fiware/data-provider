...
| **Target Revision** | `3.1.2` (your chart version) | `spec.source.targetRevision` |
...
| `3.1.2` / `v3.1.2` | `targetRevision`, `values.branch` | The Helm chart version and corresponding Git branch for your release |
...
spec:
  ...
  source:
    ...
    path: '""'
    targetRevision: 3.1.2                              # version of package
    helm:
      values: |
        values:
          branch: v3.1.2                               # branch of repo with values - for released version it should be the release branch
