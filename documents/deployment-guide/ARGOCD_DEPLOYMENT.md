...
| `4.0.2` / `v4.0.2` | `targetRevision`, `values.branch` | The Helm chart version and corresponding Git branch for your release |
...
| `4.0.2` (your chart version) | `spec.source.targetRevision` | Target revision |
...
spec:
  ...
  source:
    ...
    path: '""'
    targetRevision: 4.0.2                              # version of package
    helm:
      values: |
        values:
          branch: v4.0.2                               # branch of repo with values - for released version it should be the release branch
