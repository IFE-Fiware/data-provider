...
| `v3.1.1` | `values.branch` | The Git branch corresponding to your release version |
...
```yaml
values:
  branch: v3.1.1                               # branch of repo with values - for released version it should be the release branch
